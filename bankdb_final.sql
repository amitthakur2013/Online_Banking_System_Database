...
--
-- Host: localhost
-- Generation Time: Apr 21, 2021 at 01:36 PM
...
ALTER TABLE `transactions`
  ADD CONSTRAINT `transactions_ibfk_3` FOREIGN KEY (`From_User_Id`) REFERENCES `user` (`User_Id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  ADD CONSTRAINT `transactions_ibfk_2` FOREIGN KEY (`From_Account_No`) REFERENCES `account` (`Acct_No`) ON DELETE CASCADE ON UPDATE CASCADE;
